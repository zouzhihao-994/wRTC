...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "screenSuffix", function() { return screenSuffix; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "iceServer", function() { return iceServer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "screenDiv", function() { return screenDiv; });
...
function joinHandler() {
    ...
    // 创建Socket
    socket = new _class_Socket__WEBPACK_IMPORTED_MODULE_1__["Socket"](socketUrl, client);
    socket.init();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Socket", function() { return Socket; });
/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(socket_io_client__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
/* harmony import */ var _RtcPeer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(54);
...
class Socket {
    ...
    constructor(socketUrl, client) {
        this._socketServer = socket_io_client__WEBPACK_IMPORTED_MODULE_0___default.a.connect(socketUrl, { transports: ['websocket'], timeout: 9999999 });
        this._client = client;
    }
    ...
    hidden_onJoined(participants, account) {
        ...
        participants.forEach(p => {
            if (p.account !== this._client.account) {
                ...
                peer.remoteScreenName = peer.peerName + _index__WEBPACK_IMPORTED_MODULE_1__["screenSuffix"];
                ...
                if (!this._client.existPeer(peer.peerName)) {
                    Object(_RtcPeer__WEBPACK_IMPORTED_MODULE_2__["createPeerConnection"])(peer, this._client, this);
                }

                // 创建一个pc，负责连接本端与对端的屏幕共享
                if (!this._client.existRemoteScreen(peer.remoteScreenName)) {
                    Object(_RtcPeer__WEBPACK_IMPORTED_MODULE_2__["createScreenConnection"])(peer, this._client, this);
                }
            }
        });
        ...
        if (account === this._client.account) {
            ...
            for (let p in this._client.peer) {
                ...
                Object(_RtcPeer__WEBPACK_IMPORTED_MODULE_2__["createOffer"])(p, this._client.peer[p], this._client, this, _index__WEBPACK_IMPORTED_MODULE_1__["AV_SHARE"]);
            }
            // 创建共享桌面连接的offer
            for (let p in this._client.remoteScreen) {
                console.log("send screen offer to", this._client.remoteScreen[p]);
                Object(_RtcPeer__WEBPACK_IMPORTED_MODULE_2__["createOffer"])(p, this._client.remoteScreen[p], this._client, this, _index__WEBPACK_IMPORTED_MODULE_1__["SCREEN_SHARE"]);
            }
        }
    }
    ...
    onScreenShared(account) {
        ...
        pc.onicecandidate = event => {
            if (event.candidate) {
                this.emitIceCandidate(event.candidate, this._client.roomId, account, _index__WEBPACK_IMPORTED_MODULE_1__["SCREEN_SHARE"]);
            }
        };
        // 设置negotiation监听
        pc.onnegotiationneeded = () => {
            Object(_RtcPeer__WEBPACK_IMPORTED_MODULE_2__["createOffer"])(account, pc, client, this, _index__WEBPACK_IMPORTED_MODULE_1__["SCREEN_SHARE"]);
        };
        // 保存{peerName:pc}
    ...
    onAnswer(data) {
        ...
        // 屏幕共享模式
        if (data.mediaType === _index__WEBPACK_IMPORTED_MODULE_1__["SCREEN_SHARE"]) {
            this._client.remoteScreen[data.source] && this._client.remoteScreen[data.source].setRemoteDescription(data.sdp, function () {}, err => {
                console.error('setRemoteDescription error:', err, data.source);
            });
        } else {
            // 音视频模式
            this._client.peer[data.source] && this._client.peer[data.source].setRemoteDescription(data.sdp, function () {}, err => {
                console.error('setRemoteDescription error:', err, data.source);
            });
        }
    }
    ...
    onTrack(peerName, stream) {
        ...
        let account = Object(_index__WEBPACK_IMPORTED_MODULE_1__["getRawPeerName"])(peerName, this._client.account);
        try {
    ...
    onPeerAddStream(pc) {
        try {
            ...
            let video = document.createElement("video");
            _index__WEBPACK_IMPORTED_MODULE_1__["div"].appendChild(video);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createScreenConnection", function() { return createScreenConnection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createPeerConnection", function() { return createPeerConnection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getScreenMediaAndAddTrack", function() { return getScreenMediaAndAddTrack; });
...
function createScreenConnection(p, client, socketServer) {
    let pc = new RTCPeerConnection(_index__WEBPACK_IMPORTED_MODULE_0__["iceServer"]);
    ...
    pc.onicecandidate = event => {
        if (event.candidate) {
            socketServer.emitIceCandidate(event.candidate, client.roomId, p.remoteScreenName, _index__WEBPACK_IMPORTED_MODULE_0__["SCREEN_SHARE"]);
        }
    };

    // 设置监听
    pc.onnegotiationneeded = () => {
        createOffer(p.remoteScreenName, pc, client, socketServer, _index__WEBPACK_IMPORTED_MODULE_0__["SCREEN_SHARE"]);
    };
...
function createPeerConnection(p, client, socketServer) {
    ...
    pc.onicecandidate = event => {
        ...
        if (event.candidate) {
            socketServer.emitIceCandidate(event.candidate, client.roomId, p.peerName, _index__WEBPACK_IMPORTED_MODULE_0__["AV_SHARE"]);
        }
    };

    pc.onnegotiationneeded = () => {
        createOffer(p.peerName, pc, client, socketServer, _index__WEBPACK_IMPORTED_MODULE_0__["AV_SHARE"]);
    };
...
function getScreenMediaAndAddTrack() {
    navigator.mediaDevices.getDisplayMedia().then(stream => {
        // 设置本地流
        _index__WEBPACK_IMPORTED_MODULE_0__["client"].setLocalScreenStream(stream);
        // 将视频流发送到所有远端屏幕上
        for (let peerName in _index__WEBPACK_IMPORTED_MODULE_0__["client"].remoteScreen) {
            try {
                _index__WEBPACK_IMPORTED_MODULE_0__["client"].localScreenStream.getTracks().forEach(track => {
                    // 设置监听onended事件
                    track.onended = _index__WEBPACK_IMPORTED_MODULE_0__["socket"].onEnded;
                    // 添加远端
                    _index__WEBPACK_IMPORTED_MODULE_0__["client"].remoteScreen[peerName].addTrack(track, _index__WEBPACK_IMPORTED_MODULE_0__["client"].localScreenStream);
                });
            } catch (e) {
                console.error('share getDisplayMedia addTrack error', e);
            }
